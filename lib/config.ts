...
// 출처: 하나은행 공식 고시 (kebhana.com, 2026-07-21 확인) — VND·TWD·PHP·IDR도 현찰 취급
...
export const CURRENCIES: Currency[] = [
  ...
  { code: "IDR", nameKo: "인도네시아 루피아", flag: "🇮🇩", koreaexim: "IDR(100)", unit: 100, frankfurter: true, spreadPct: 10, discount: 0, decimals: 0 },
  { code: "MYR", nameKo: "말레이시아 링깃", flag: "🇲🇾", koreaexim: "MYR", unit: 1, frankfurter: true, spreadPct: 7.4, discount: 0, decimals: 2 },
  ...
  { code: "CHF", nameKo: "스위스 프랑", flag: "🇨🇭", koreaexim: "CHF", unit: 1, frankfurter: true, spreadPct: 1.97, discount: 0.3, decimals: 2 },
